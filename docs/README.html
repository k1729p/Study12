...
<H3>Research Swing, Bean Validation, CDI, and RESTful Web Services</H3>
<p>
...
<P><IMG src="images/MainMenu.png" height="131" width="610"/><BR>
...
<P>Action:<BR/>
<img src="images/orangeHR-500.png"><BR/>
<img src="images/orangeSquare.png"> 1. Push the button "Validation".<BR/>
<img src="images/orangeHR-500.png"></P>
...
<H3 id="valid_item"><img src="images/greenCircle.png"> 2.1. Validation Example "Validate Item"</H3>

<P>Action:<BR/>
<img src="images/orangeHR-500.png"><BR/>
<img src="images/orangeSquare.png"> 1. Push the button "Validate Item".<BR/>
<img src="images/orangeHR-500.png"></P>
...
'<a href="https://github.com/k1729p/Study12/blob/main/src/main/java/kp/validation/data/ItemCons.java#L18">ItemCons::getVal</a>' method.
</p>
...
The implemented method: '<a href="https://github.com/k1729p/Study12/blob/main/src/main/java/kp/validation/data/impl/ItemConsImplNoCons.java#L29">
...
The implemented method: '<a href="https://github.com/k1729p/Study12/blob/main/src/main/java/kp/validation/data/impl/ItemConsImplCons.java#L33">
ItemConsImplCons::getVal</a>'.
</LI>
</UL>
</p>
<p>2.1.3. In the method
'<a href="https://github.com/k1729p/Study12/blob/main/src/main/java/kp/validation/ResearchValidation.java#L94">ResearchValidation::validateItem</a>' 
...
<a href="#top">Back to the top of the page</a>
<H3 id="valid_box"><img src="images/greenCircle.png"> 2.2. Validation Example "Validate Box Of Items"</H3>

<P>Action:<BR/>
<img src="images/orangeHR-500.png"><BR/>
<img src="images/orangeSquare.png"> 1. Push the button "Validate Box Of Items".<BR/>
<img src="images/orangeHR-500.png"></P>
...
'<a href="https://github.com/k1729p/Study12/blob/main/src/main/java/kp/validation/ResearchValidation.java#L140">ResearchValidation::validateBoxOfItems</a>' 
...
<a href="#top">Back to the top of the page</a>
<H3 id="valid_method"><img src="images/greenCircle.png"> 2.3. Validation Example "Validate Method"</H3>

<P>Action:<BR/>
<img src="images/orangeHR-500.png"><BR/>
<img src="images/orangeSquare.png"> 1. Push the button "Validate Method".<BR/>
<img src="images/orangeHR-500.png"></P>
...
'<a href="https://github.com/k1729p/Study12/blob/main/src/main/java/kp/validation/data/OperCons.java#L15">OperCons::process</a>':
<UL>
...
'<a href="https://github.com/k1729p/Study12/blob/main/src/main/java/kp/validation/ResearchValidation.java#L209">ResearchValidation::validateOperMethod</a>' 
...
<P>Action:<BR/>
<img src="images/orangeHR-500.png"><BR/>
<img src="images/orangeSquare.png"> 1. Push the button "CDI".<BR/>
<img src="images/orangeHR-500.png"></P>
...
<H3 id="c_d_i_alternative"><img src="images/greenCircle.png"> 3.1. CDI Example "Alternative &amp; Qualified Beans"</H3>

<P>Action:<BR/>
<img src="images/orangeHR-500.png"><BR/>
<img src="images/orangeSquare.png"> 1. Push the button "Alternative &amp; Qualified Beans".<BR/>
<img src="images/orangeHR-500.png"></P>
...
<p>3.1.3. The method 
'<a href="https://github.com/k1729p/Study12/blob/main/src/main/java/kp/cdi/alternatives/BasicBeanImplScript.java#L31">BasicBeanImplScript::show</a>' 
...
<p>3.1.6. The method 
'<a href="https://github.com/k1729p/Study12/blob/main/src/main/java/kp/cdi/ResearchCDIBean.java#L144">ResearchCDIBean::note</a>' 
presents those three 'foreseeable' objects.</LI>
</p>
...
<a href="#top">Back to the top of the page</a>
<H3 id="c_d_i_decorated"><img src="images/greenCircle.png"> 3.2. CDI Example "Decorated Beans"</H3>

<P>Action:<BR/>
<img src="images/orangeHR-500.png"><BR/>
<img src="images/orangeSquare.png"> 1. Push the button "Decorated Beans".<BR/>
<img src="images/orangeHR-500.png"></P>
...
'<a href="https://github.com/k1729p/Study12/blob/main/src/main/java/kp/cdi/ResearchCDIBean.java#L156">ResearchCDIBean::decoratedBeans</a>'.
</p>
<p>3.2.3. The method 
'<a href="https://github.com/k1729p/Study12/blob/main/src/main/java/kp/cdi/decorators/DecoratedBeanImpl.java#L39">DecoratedBeanImpl::show</a>' 
calls the method 
'<a href="https://github.com/k1729p/Study12/blob/main/src/main/java/kp/cdi/decorators/PlainBeanImpl.java#L29">PlainBeanImpl::show</a>' two times:
<UL>
...
'<a href="https://github.com/k1729p/Study12/blob/main/src/main/java/kp/cdi/decorators/PlainBeanImpl.java#L29">PlainBeanImpl::show</a>' method.
</P>
...
<a href="#top">Back to the top of the page</a>
<H3 id="c_d_i_intercepted"><img src="images/greenCircle.png"> 3.3. CDI Example "Intercepted Beans"</H3>

<P>Action:<BR/>
<img src="images/orangeHR-500.png"><BR/>
<img src="images/orangeSquare.png"> 1. Push the button "Intercepted Beans".<BR/>
<img src="images/orangeHR-500.png"></P>
...
'<a href="https://github.com/k1729p/Study12/blob/main/src/main/java/kp/cdi/ResearchCDIBean.java#L171">ResearchCDIBean::interceptedBeans</a>'.
</p>
<p>3.3.2. The interceptor computes in the method 
'<a href="https://github.com/k1729p/Study12/blob/main/src/main/java/kp/cdi/interceptors/ElapsedInterceptor.java#L36">
ElapsedInterceptor::measure</a>' the methods execution.<br>
...
has four methods:
<UL>
<LI>'<a href="https://github.com/k1729p/Study12/blob/main/src/main/java/kp/cdi/interceptors/ElapsedBean.java#L21">ElapsedBean::notPaused</a>' - 
runs without any pause (empty method without any body)</LI>
<LI>'<a href="https://github.com/k1729p/Study12/blob/main/src/main/java/kp/cdi/interceptors/ElapsedBean.java#L31">ElapsedBean::pausedNano</a>' - 
pauses one nanosecond</LI>
<LI>'<a href="https://github.com/k1729p/Study12/blob/main/src/main/java/kp/cdi/interceptors/ElapsedBean.java#L44">ElapsedBean::pausedMicro</a>' - 
pauses one microsecond</LI>
<LI>'<a href="https://github.com/k1729p/Study12/blob/main/src/main/java/kp/cdi/interceptors/ElapsedBean.java#L57">ElapsedBean::pausedMilli</a>' - 
...
<a href="#top">Back to the top of the page</a>
<H3 id="c_d_i_events"><img src="images/greenCircle.png"> 3.4. CDI Example "Events"</H3>

<P>The CDI advantage: no type erasure for the event type.</P>

<P>Action:<BR/>
<img src="images/orangeHR-500.png"><BR/>
<img src="images/orangeSquare.png"> 1. Push the button "Events".<BR/>
<img src="images/orangeHR-500.png"></P>
...
has the method 
'<a href="https://github.com/k1729p/Study12/blob/main/src/main/java/kp/cdi/events/observers/BasicObserver.java#L29">BasicObserver::showPayload</a>'.<br>
...
'<a href="https://github.com/k1729p/Study12/blob/main/src/main/java/kp/cdi/events/observers/BasicObserver.java#L29">BasicObserver::showPayload</a>'.
</p>
...
event in the parent class method 
'<a href="https://github.com/k1729p/Study12/blob/main/src/main/java/kp/cdi/events/observers/BasicObserver.java#L29">
...
event in the method '<a href="https://github.com/k1729p/Study12/blob/main/src/main/java/kp/cdi/events/observers/BigObserver.java#L31">
BigObserver::showPayloadList</a>'</LI>
<LI>the 'List&lt;String&gt;' event in the method 
'<a href="https://github.com/k1729p/Study12/blob/main/src/main/java/kp/cdi/events/observers/BigObserver.java#L45">
...
<H3 id="restful_content"><img src="images/greenCircle.png"> 4.1. RESTful Example "Content GET"</H3>

<P>Action:<BR/>
<img src="images/orangeHR-500.png"><BR/>
<img src="images/orangeSquare.png"> 1. Push the button "Content GET".<BR/>
<img src="images/orangeHR-500.png"></P>

<p>4.1.1 The method
'<a href="https://github.com/k1729p/Study12/blob/main/src/main/java/kp/restful/ResearchRestful.java#L44">ResearchRestful::process</a>'
<UL>
...
The method 
'<a href="https://github.com/k1729p/Study12/blob/main/src/main/java/kp/restful/client/ContentClient.java#L35">ContentClient::process</a>' 
...
<UL>
<LI>the method 
'<a href="https://github.com/k1729p/Study12/blob/main/src/main/java/kp/restful/data/Content.java#L32">Content::getUsingPathAndQuery</a>':<br> 
annotations '@PathParam' and '@QueryParam', parameter type 'String'</LI>
<LI>the method 
'<a href="https://github.com/k1729p/Study12/blob/main/src/main/java/kp/restful/data/Content.java#L53">Content::getUsingContext</a>':<br> 
...
<a href="#top">Back to the top of the page</a>
<H3 id="restful_boxes_internal"><img src="images/greenCircle.png"> 4.2. RESTful Example "Boxes CRUD (Internal Client)"</H3>

<P>Action:<BR/>
<img src="images/orangeHR-500.png"><BR/>
<img src="images/orangeSquare.png"> 1. Push the button "Boxes CRUD (Internal Client)".<BR/>
<img src="images/orangeHR-500.png"></P>
...
<p>4.2.2 The method 
'<a href="https://github.com/k1729p/Study12/blob/main/src/main/java/kp/restful/client/BoxesClient.java#L35">BoxesClient::process</a>' 
...
The resource method 
'<a href="https://github.com/k1729p/Study12/blob/main/src/main/java/kp/restful/data/SetOfBoxes.java#L55">SetOfBoxes::createBox</a>' 
validates 
...
object with id 1.<br>
The resource method 
'<a href="https://github.com/k1729p/Study12/blob/main/src/main/java/kp/restful/data/SetOfBoxes.java#L79">SetOfBoxes::readBox</a>' 
uses HTTP GET.
</p>
...
'<a href="https://github.com/k1729p/Study12/blob/main/src/main/java/kp/restful/data/SetOfBoxes.java#L100">SetOfBoxes::readBoxes</a>' 
uses HTTP GET.
</p>
...
id 1 and text "X".<br>
The resource method 
'<a href="https://github.com/k1729p/Study12/blob/main/src/main/java/kp/restful/data/SetOfBoxes.java#L118">SetOfBoxes::updateBox</a>' validates 
...
object with id 2.<br>
The resource method 
'<a href="https://github.com/k1729p/Study12/blob/main/src/main/java/kp/restful/data/SetOfBoxes.java#L149">SetOfBoxes::deleteBox</a>' 
uses HTTP DELETE.
</p>
...
<a href="#top">Back to the top of the page</a>
<H3 id="restful_boxes_external"><img src="images/greenCircle.png"> 4.3. RESTful Example "Boxes CRUD (External Client)"</H3>

<P>Action:<BR/>
<img src="images/orangeHR-500.png"><BR/>
<img src="images/orangeSquare.png"> 1. Push the button "Boxes CRUD (External Client)".</BR>
...
<img src="images/orangeSquare.png"> 2. Start batch file 
...
<img src="images/orangeSquare.png"> 3. After finishing the execution of the batch file press button 'Enter' in the main window to shut down the server.</BR>
<img src="images/orangeSquare.png"><img src="images/spacer-32.png">
